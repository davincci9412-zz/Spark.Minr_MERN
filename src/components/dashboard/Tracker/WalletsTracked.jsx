  ...
  render(){
    if (this.props.type === "gear"){
      ...
      if (this.props.fullwidth ==="1"){
        ...
        return <div className="td">{this.props.placeholder.substring(0, 20).concat("...")}</div>  
      }
  ...
  render(){
	return  <div className="table">
      <div className="tr">
        ...
        <Column type='transaction_amount' placeholder={this.props.transaction_amount} orientation={this.props.transaction_orientation} />
      </div>
