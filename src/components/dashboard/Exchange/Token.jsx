...
class Inputs extends React.Component {
  constructor(props) {
	super(props);
	this.state = { tokenValid: false,  buyValid: false, sellValid: false,  bufferValid: false, formValid: false, token:'', exchange1:'', exchange2:'', exchange3:'', potential:'', percentage:'', buy:'', sell:'', status:'', transaction:'', trend:'', buy_fee:'', transfer_fee:'', sell_fee:'', buffer_fee:'', total:''};
